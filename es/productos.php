          ...
          <div class="container-fluid dashboard-default-sec">
            <div class="row">  
              <div class="col-xl-12 box-col-12 des-xl-100"> 
                <button class="btn btn-primary open_modal" style="opacity:0" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalfat" data-whatever="@mdo">Open modal for @mdo</button>
                <div class="row">
                  <?php
                    $productosQuery = mysqli_query($con, "SELECT * FROM producto");
                    if(mysqli_num_rows($productosQuery) > 0){
                      while($productosData = mysqli_fetch_assoc($productosQuery)){
                        $productoId = $productosData['id'];
                  ?>
                  <div class="col-xl-3 col-md-6 box-col-6 des-xl-50">
                    <div class="card">
                      ...
                      <div class="card-body text-center p-t-0">
                        <h3 class="font-dark"><?php echo $productosData['nombre'];?></h3>
                        ...
                        <button class="btn btn-light" onclick="location.href='producto.php?id=<?php echo $productoId;?>';">Ver</button>
                        <br><br>
                      </div>
                    </div>
                  </div>
                  ...
                  ?>
                  <div class="col-xl-2 col-md-6 box-col-6 des-xl-50 add-new-product" data-bs-target="#exampleModalfat" data-whatever="@mdo">
                    <div class="card">
                      <div class="card-header">
                        <div class="header-top">
                        </div>
                      ...
                      <div class="card-body text-center p-t-0">
                        <h3 class="font-dark"><i data-feather="plus"></i></h3>
                  ...
                  <div class="col-xl-3 col-md-6 box-col-6 des-xl-50">
                    <div class="card">
                      ...
                      <div class="card-body text-center p-t-0">
                        <h3 class="font-dark">No se encontraron productos en stock.</h3>
                        <p>Debe crear un nuevo producto para registrar nuevas unidades.</p>
                        <button class="btn btn-light new-product" type="button" data-bs-target="#exampleModalfat" data-whatever="@mdo">Registrar un nuevo Producto</button>                
                        <br><br>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel2">Crear Nuevo Producto</h5>
                            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                          </div>
                          <div class="modal-body">
                            <div class="mb-3">
                              <label class="col-form-label" for="recipient-name">Nombre:</label>
                              <input class="form-control nombre-producto" type="text">
                            </div>
                          </div>
                          <div class="modal-footer">
                            <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button>
                            <button class="btn btn-primary crear-Producto" type="button">Crear</button>
                          </div>
                        </div>
                      </div>
                    </div>            
