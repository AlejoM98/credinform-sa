  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper sidebar-icon">
        ...
        <!-- Page Sidebar Ends-->
        <?php
          $productoQuery = mysqli_query($con, "SELECT * FROM producto WHERE id='".intval($_REQUEST['id'])."' ");
          $dataProducto = mysqli_fetch_assoc($productoQuery);
        ?>
        <div class="page-body">
          ...
          <div class="container-fluid dashboard-default-sec">
            <div class="row">  
              <div class="col-sm-6">
                  <h3><?php echo $dataProducto['nombre']; ?> <button class="btn btn-dark nuevo-registro" type="button">Agregar Nuevo Registro</button></h3>
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Inicio</a></li>
                    <li class="breadcrumb-item">Productos</li>
                    <li class="breadcrumb-item active"><?php echo $dataProducto['nombre']; ?></li>
                  </ol>
                </div>
              <div class="col-xl-12 box-col-12 des-xl-100"> 
                <div class="row">   
                  <div class="col-xl-8 col-md-6 box-col-6 des-xl-50">
                    <div class="card">
                      ...
                      <table class="display datatables" id="table-unidades">
                        <thead>
                          <tr>
                            <th>Imagen</th>
                            <th>Marca</th>
                        ...
                        <tbody>
                          <?php
                            $unidadQuery = mysqli_query($con, "SELECT * FROM unidad WHERE producto='".$_REQUEST['id']."' ");
                            if(mysqli_num_rows($unidadQuery) > 0){
                              while($unidadData = mysqli_fetch_assoc($unidadQuery)){
                          ?>
                          <tr>
                            <td><?php $unidadData['imagen'];?></td>
                            <td><?php $unidadData['marca'];?></td>
                            <td><?php $unidadData['volumen'].' ml';?></td>
                            <td><?php $unidadData['descripcion'];?></td>
                            <td><?php $unidadData['cantidad'];?></td>
                            <td><?php $unidadData['precio'];?></td>
                            <td><?php 'Correcto';?></td>
                          </tr>
                          <?php
                              }
                          ...
                          <tr>
                            <td colspan="7">
                              No se encontraron registros. <button class="btn btn-dark nuevo-registro" type="button">Agregar Nuevo Registro</button>
                            </td>
          ...
          <div class="customizer-contain"> 
            <div class="tab-content" id="c-pills-tabContent">
              <div class="customizer-header"> 
                ...
                <h5>Crear un nuevo registro</h5> 
                <p class="mb-0">Crear una nueva unidad para el producto seleccionado.</p>
              </div>
              <div class="customizer-body custom-scrollbar"> 
                <div class="tab-pane fade show active" id="layout-type"> 
                  <div class="row">
                    <div class="col-xl-12">
                      <div class="mb-3">
                        <label class="col-form-label" for="recipient-name">Marca:</label>
                        <input class="form-control nombre-producto" type="text">
                      </div>
                    </div>
                    <div class="col-xl-12">
                      <div class="mb-3">
                        <label class="col-form-label" for="recipient-name">Volumen:</label>
                        <input class="form-control nombre-producto" type="text">
                      </div>
                    </div>
                    <div class="col-xl-12">
                      <div class="mb-3">
                        <label class="col-form-label" for="recipient-name">Descripcion:</label>
